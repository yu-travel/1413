 ...
 */
void ring_buffer_init(ring_buffer_t *buffer, u32 *buf, size_t buf_size);
 ...
 */
void ring_buffer_queue(ring_buffer_t *buffer, u32 data);
 ...
 */
void ring_buffer_queue_arr(ring_buffer_t *buffer, const u32 *data, ring_buffer_size_t size);
 ...
 */
uint8_t ring_buffer_dequeue(ring_buffer_t *buffer, u32 *data);
 ...
 */
ring_buffer_size_t ring_buffer_dequeue_arr(ring_buffer_t *buffer, u32 *data, ring_buffer_size_t len);
/**
 ...
 * @return 1 if data was returned; 0 otherwise.
 */
uint8_t ring_buffer_peek(ring_buffer_t *buffer, u32 *data, ring_buffer_size_t index);
