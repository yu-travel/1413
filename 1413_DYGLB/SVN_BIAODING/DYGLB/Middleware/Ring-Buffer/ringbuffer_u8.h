 ...
 */
typedef struct u8_ring_buffer_t u8_ring_buffer_t;
 ...
 */
inline uint8_t u8_ring_buffer_is_empty(u8_ring_buffer_t *buffer) {
 ...
 */
inline uint8_t u8_ring_buffer_is_full(u8_ring_buffer_t *buffer) {
 ...
 */
inline ring_buffer_size_t u8_ring_buffer_num_items(u8_ring_buffer_t *buffer) {
