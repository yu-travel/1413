...
// 定义两个 AD5542 芯片的配置
AD5542_ConfigTypeDef ad5542_GSDJ1 = {
    .cs_gpio_port = GPIOB,
...
AD5542_ConfigTypeDef ad5542_GSDJ2 = {
    .cs_gpio_port = GPIOC,
    .cs_gpio_pin = GPIO_Pin_0,
    .ldac_gpio_port = GPIOB,
    .ldac_gpio_pin = GPIO_Pin_10
};
AD5542_ConfigTypeDef ad5542_DYGY = {
	.cs_gpio_port = GPIOC,
...
void AD5542_Init()
{
	...
	AD5542_InitCommon();
	// 初始化单个 AD5542 芯片
	AD5542_InitSingle(&ad5542_GSDJ1);
	AD5542_InitSingle(&ad5542_GSDJ2);
	AD5542_InitSingle(&ad5542_DYGY);
}
...
void AD5542Analog_data_Conversion()
{
	...
	for (i = 0;i < DEVNUM; i++)
    {
		...
		{
			case 0:
				temp = (limit_Current_Data[i]/1000.0f)*0.5;  //temp：为4001芯片限流limit_Current_Data，所需要提供的电压，单位V
				limit_Ad5524_Data[GSDJ1_DEV_NUM]=temp*26214;
				LYSprintf(LYSDEBUG3, "********	limit_Ad5524_Data[GSDJ1_DEV_NUM]	=	%d	**************\r\n",limit_Ad5524_Data[i]);
				break;
			case 1:
				temp = (limit_Current_Data[i]/1000.0f)*0.5;
				limit_Ad5524_Data[GSDJ2_DEV_NUM]=temp*26214;
				LYSprintf(LYSDEBUG3, "********	limit_Ad5524_Data[GSDJ2_DEV_NUM]	=	%d	**************\r\n",limit_Ad5524_Data[i]);				
				break;		
			case 2:
				temp = (limit_Current_Data[i]/1000.0f)*0.5;
				limit_Ad5524_Data[DYGY_DEV_NUM]=temp*26214;
				LYSprintf(LYSDEBUG3, "********	limit_Ad5524_Data[DYGY_DEV_NUM]	=	%d	**************\r\n",limit_Ad5524_Data[i]);				
				break;	
			default:
...
void Ad5542_Send_Data()
{
	...
	switch(temp)
	{
		case 0:
			//向GSDJ1的5542发送数据
			AD5542_WriteData(&ad5542_GSDJ1, limit_Ad5524_Data[0]);
			AD5542_TriggerLDAC(&ad5542_GSDJ1);
			break;
		case 1:
			//向GSDJ2的5542发送数据
			AD5542_WriteData(&ad5542_GSDJ2, limit_Ad5524_Data[1]);
			AD5542_TriggerLDAC(&ad5542_GSDJ2);
			break;
		case 2:
			//向DYGY的5542发送数据
			AD5542_WriteData(&ad5542_DYGY, limit_Ad5524_Data[2]);
			AD5542_TriggerLDAC(&ad5542_DYGY);
			break;
		default:
			LYSprintf(LYSDEBUG4, "WARNING!!!!!!!  FATAL ERROE,PLEASE CHECK CODE\r\n");
		break;
...
//	}
	//向GSDJ1的5542发送数据
//	AD5542_WriteData(&ad5542_GSDJ1, a*2*26214);
//	AD5542_TriggerLDAC(&ad5542_GSDJ1);
	//向DYGY的5542发送数据
	AD5542_WriteData(&ad5542_DYGY, a*26214);
	AD5542_TriggerLDAC(&ad5542_DYGY);
#endif
}
