...
typedef union {
    uint16_t raw;
    struct {
        uint16_t hjjc1_stu:1;
        uint16_t hjjc2_stu:1;
		uint16_t bf_stu:1;
		uint16_t waoxj_stu:1;		
        uint16_t hjjc1_default:1;
        uint16_t hjjc2_default:1;
		uint16_t bf_default:1;
		uint16_t waoxj_default:1;
        uint16_t hjjc1_warning:1;
        uint16_t hjjc2_warning:1;
		uint16_t bf_warning:1;
		uint16_t waoxj_warning:1;		
...
typedef union {
	uint8_t all;
	struct {
        uint16_t hjjc1_default_save:1;
        uint16_t hjjc2_default_save:1;
		uint16_t bf_default_save:1;
		uint16_t waoxj_default_save:1;
	}bits;
