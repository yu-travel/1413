	...
	for (i = 0;i < 8; i++)
    {
		...
		switch (i)
		{
			...
			case 1:
				...
				break;
			case 2:
				analog_data[0] = (adc * 10*1000)*2.0493 / 32768;	//GSDJ1
				break;
			case 3:
				...
				break;
			case 4:
				analog_data[4] = (adc * 10*1000)*2.0493 / 32768;	//DYGY
				break;
			case 5:
				...
				break;
			case 6:
				analog_data[2] = (adc * 10*1000)*2.0493 / 32768;	//GSDJ2
				break;
			case 7:
		...
		switch (i)
		{
			...
			case 2:
				...
				analog_data[0] = k[MCU2_12V_GSDJ1]*analog_data[0]+b[MCU2_12V_GSDJ1];
				break;
			case 3:
				temp=(adc * 10*1000) / 32768;				//GSDJ1
				analog_data[1] = temp / 0.5;
			...
			case 4:
				...
				analog_data[4] = k[MCU2_12V_DYGY]*analog_data[4]+b[MCU2_12V_DYGY];
				break;
			case 5:
				temp=(adc * 10*1000) / 32768;				//DYGY
				analog_data[5] = temp /0.5;
			...
			case 6:
				...
				analog_data[2] = k[MCU2_12V_GSDJ2]*analog_data[2]+b[MCU2_12V_GSDJ2];
				break;
			case 7:
				temp=(adc * 10*1000) / 32768;				//GSDJ2
				analog_data[3] = temp / 0.5;
