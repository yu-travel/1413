...
#define DEV_STU_GET()\
	do{	sendmessage.stuAndwarning.bits.gsdj1_stu=   GPIO_ReadOutputDataBit(GPIOC,GPIO_Pin_7);\
		sendmessage.stuAndwarning.bits.gsdj2_stu=   GPIO_ReadOutputDataBit(GPIOC,GPIO_Pin_4);\
		sendmessage.stuAndwarning.bits.dygy_stu=    GPIO_ReadOutputDataBit(GPIOC,GPIO_Pin_13);\
		sendmessage.stuAndwarning.bits.gsdj1_warning=   !(GPIO_ReadInputDataBit(GPIOC,GPIO_Pin_8));\
		sendmessage.stuAndwarning.bits.gsdj2_warning=   !(GPIO_ReadInputDataBit(GPIOC,GPIO_Pin_5));\
	    sendmessage.stuAndwarning.bits.dygy_warning=    !(GPIO_ReadInputDataBit(GPIOC,GPIO_Pin_14));\
	    sendmessage.stuAndwarning.bits.gsdj1_default=before_default_config_power.bits.gsdj1_default_save;\
		sendmessage.stuAndwarning.bits.gsdj2_default=before_default_config_power.bits.gsdj2_default_save;\
		sendmessage.stuAndwarning.bits.dygy_default=before_default_config_power.bits.dygy_default_save;\
	  }while(0)
/******************* 			Extern	Declare				   ********************/
...
void data_Packet_Creat()
{
	...
	{
	    base = i * 3;
	    sendmessage.messageData[base] = i+MCU2_12V_GSDJ1;            //设备号
...
uint32_t save_Default_Power()
{
	...
	now_default_config_power.bits.gsdj1_default_save=recivemessage.stuAndwarning.bits.gsdj1_default;
	now_default_config_power.bits.gsdj2_default_save=recivemessage.stuAndwarning.bits.gsdj2_default;
	now_default_config_power.bits.dygy_default_save=recivemessage.stuAndwarning.bits.dygy_default;
