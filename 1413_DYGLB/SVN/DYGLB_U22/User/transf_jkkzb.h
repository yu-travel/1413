...
typedef union {
    uint16_t raw;
    struct {
        uint16_t gsdj1_stu:1;
        uint16_t gsdj2_stu:1;
		uint16_t dygy_stu:1;
        uint16_t reseive_1:1;
        uint16_t gsdj1_default:1;
        uint16_t gsdj2_default:1;
		uint16_t dygy_default:1;
        uint16_t reseive_2:1;
        uint16_t gsdj1_warning:1;
        uint16_t gsdj2_warning:1;
		uint16_t dygy_warning:1;
        uint16_t reseive_3:5;
    } bits;
} STUSIG_PACKED;
...
typedef union {
	uint8_t all;
	struct {
		uint8_t gsdj1_default_save:1;
		uint8_t gsdj2_default_save  :1;
		uint8_t dygy_default_save  :1;
	}bits;
