...
//		{
//			case 0:
//				analog_data[2] = (adc * 10*1000)*4.1571 / 32768;//KF电
//				break;
//			case 1:
...
//		}
		...
		{
			case 0:
				analog_data[2] = (adc * 10*1000)*4 / 32768;//KF电压
				analog_data[2] = k[MCU1_28V_KF]*analog_data[2]+b[MCU1_28V_KF];
				break;
			case 1:
				temp=(adc * 10*1000) / 32768;
				analog_data[3] = temp /0.125;//KF电流
			...
			case 2:
				analog_data[0] = (adc * 10*1000)*4 / 32768;//TSGY电压
				analog_data[0]=k[MCU1_28V_TSGY]*analog_data[0]+b[MCU1_28V_TSGY];
				break;
			case 3:
				temp=(adc * 10*1000) / 32768;
				analog_data[1] = temp / 0.5;//TSGY电流
