...
#define DEV_STU_GET()\
	do{	sendmessage.stuAndwarning.bits.sfxj_stu=   GPIO_ReadOutputDataBit(GPIOA,GPIO_Pin_9);\
	    ...
	    sendmessage.stuAndwarning.bits.sfxj_default=before_default_config_power.bits.sfxj_default_save;\
		sendmessage.stuAndwarning.bits.sfpsd_default=before_default_config_power.bits.sfpsd_default_save;\
		sendmessage.stuAndwarning.bits.bqxj_default=before_default_config_power.bits.bqxj_default_save;\
		sendmessage.stuAndwarning.bits.qgsj_default=before_default_config_power.bits.qgsj_default_save;\
	  }while(0)
/******************* 			Extern	Declare				   ********************/
...
uint32_t save_Default_Power()
{
	...
	now_default_config_power.bits.sfxj_default_save=recivemessage.stuAndwarning.bits.sfxj_default;
	now_default_config_power.bits.sfpsd_default_save=recivemessage.stuAndwarning.bits.sfpsd_default;
	now_default_config_power.bits.bqxj_default_save=recivemessage.stuAndwarning.bits.bqxj_default;
	now_default_config_power.bits.qgsj_default_save=recivemessage.stuAndwarning.bits.qgsj_default;
