...
typedef union {
    ...
    struct {
		...
		uint16_t bqxj_stu:1;
		uint16_t qgsj_stu:1;		
        uint16_t sfxj_default:1;
        uint16_t sfpsd_default:1;
		uint16_t bqxj_default:1;
		uint16_t qgsj_default:1;
...
typedef union {
	uint8_t all;
	struct {
        uint16_t sfxj_default_save:1;
        uint16_t sfpsd_default_save:1;
		uint16_t bqxj_default_save:1;
		uint16_t qgsj_default_save:1;
	}bits;
