	...
	for (i = 0;i < 8; i++)
    {
		...
		switch (i)
		{
			...
			case 2:
				...
				break;
			case 3:
				analog_data[4] = (adc * 10*1000)*4.1615 / 32768;		//BQXJ
				break;
			case 4:
				...
				break;
			case 5:
				analog_data[6] = (adc * 10*1000)*4.1026 / 32768;		//BF
				break;
			case 6:
				...
				break;
			case 7:
				analog_data[2] = (adc * 10*1000)*4.1205 / 32768;		//SFPSD
				break;
			default:
				break;				
		}	
		...
		switch (i)
		{
			...
			case 1:
				analog_data[0] = (adc * 10*1000)*4 / 32768; 	//SFXJ_电压
				analog_data[0] = k[MCU3_28V_SFXJ]*analog_data[0]+b[MCU3_28V_SFXJ];
				break;
			case 2:
				temp=(adc * 10*1000) / 32768;					//BQXJ
				analog_data[5] = temp /0.5;
			...
			case 3:
				...
				analog_data[4] = k[MCU3_28V_BQXJ]*analog_data[4]+b[MCU3_28V_BQXJ];
				break;
			case 4:
				temp=(adc * 10*1000) / 32768;					//BF
				analog_data[7] = temp / 0.5;
			...
			case 5:
				...
				analog_data[6] = k[MCU3_28V_QGSJ]*analog_data[6]+b[MCU3_28V_QGSJ];				
			...
			case 7:
				...
				analog_data[2] = k[MCU3_28V_SFPSD]*analog_data[2]+b[MCU3_28V_SFPSD];	
