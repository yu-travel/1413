...
/*lys:1413的epprom芯片是16位的寻址地址，所以这里需要改动*/
	...
	{
		I2C_SendData(eeprom.dev, WriteAddr&0xFF);
...
uint32_t I2C_EE_BufferRead(u8* pBuffer, u8 ReadAddr, u16 NumByteToRead)
{
	...
	{
		I2C_SendData(eeprom.dev, ReadAddr&0xFF);
    ...
    I2C_Send7bitAddress(eeprom.dev, eeprom.peeraddr, I2C_Direction_Receiver);
