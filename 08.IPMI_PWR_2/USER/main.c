...
_pwr_abnormal_t pwr_abnormal = {
    .AB_ID_PWR_EEPROM       = AB_PWR2_EEPROM,
    .AB_ID_PWR_TEMPRETURE   = ID_TEMPRETURE,
    .AB_ID_PWR_VCC12V_1     = ID_VCC28V_1,  //新增电源板为28V
    .AB_ID_PWR_VCC12V_2     = ID_VCC28V_2,
...
void sysmon_abnormal_set(u16 vol12_1, u16 vol12_2, u16 vol33, _pwr_abnormal_t *abnormal)
{
    ...
    if(vol12_1 < 2600)// 低于26V
    {
        abnormal->AB_PWR_VCC12V_1 = AB_STA_UNDERVOLTAGE;
    }else if(vol12_1 > 3000) // 高于30V
    {
...
void sysmon_data_get(_board_monitor_t *sysmon)
{
    ...
    v12_1=(float)((vol12_1 * (3.3 /4096)-1.25) * 22.4);
    v12_1=(v12_1>12) ? 28 : v12_1;
    
    v12_2=(float)(vol12_2 * (3.3 /4096) * 11.2);
    v12_2=(v12_2>12) ? 28 : v12_2;
    
//    v33=(float)vol33* (3.3 /4096)*1.32+0.02;
//    v33=(v33>3.3) ? 3.3 : v33;
    
    c12_1=(float)(cur12_1*(3.3/4096)*7.7559-9.7445);
    c12_1=(c12_1<0) ? 0 : c12_1;
    //c12_1=(cur12_1<192) ? 0 : c12_1;
    
    c12_2=(float)(cur12_2*(3.3/4096)*5.3502 - 6.6053);
    c12_2=(c12_2<0) ? 0 : c12_2;
    //c12_2=(cur12_2<34) ? 0 : c12_2;
    
//    c33=(float)cur33*(3.3/4096)*2.5654-0.0154;
//    c33=(c33<0) ? 0 : c33;
//    c33=(cur33<24) ? 0 : c33;
...
//    sysmon->vcc3v3_curr = (u16)(c33*100);
    ...
    TRACE_OUT(DEBUG_OUT, "voltage V28_1: %d\r\n", (u16)(v12_1*100));
    TRACE_OUT(DEBUG_OUT, "current V28_1: %d*10mA\r\n", (u16)(c12_1*100));
    
    TRACE_OUT(DEBUG_OUT, "voltage V28_2: %d\r\n",(u16)(v12_2*100));
    TRACE_OUT(DEBUG_OUT, "current V28_2: %d*10mA\r\n",(u16)(c12_2*100));
