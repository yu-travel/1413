...
#define IPMI_PWR_I2CA_ID            0x2B        // IPMI转接板I2CA从机地址
#define IPMI_PWR_I2CB_ID            0x2C        // IPMI转接板I2CB从机地址
...
typedef struct {
    ...
    u8 AB_ID_PWR_TEMPRETURE;       // 电源板温度设备异常
    u8 AB_ID_PWR_EEPROM;           // 电源板EEPROM异常
    u8 AB_ID_PWR_VCC12V_1;         // 电源板电压异常
    u8 AB_ID_PWR_VCC12V_2;         // 同上
    //u8 AB_ID_PWR_VCC3V3;           // 同上
...
typedef struct {
    u8 slot_addr;
    s16 tempreture;
    u16 vcc12v_1; // 电压扩大100倍
    u16 vcc12v_2; // 电压扩大100倍
    u16 vcc12v_1_curr; // 电压扩大100倍
    u16 vcc12v_2_curr;  // 电压扩大100倍
    u16 vcc3v3;  // 电压扩大100倍
    u16 vcc3v3_curr;  // 电压扩大100倍
}_board_monitor_t;

extern _board_monitor_t sysmon;
extern _pwr_abnormal_t pwr_abnormal;
